        ...
        <Form className="py-4">
          ...
          <div className="fs-5 text-center mt-2 d-flex justify-content-center align-items-center flex-column">
            <div>
              ...
              />
              <label className="ms-2 fs-5 text-dark cursor-pointer" htmlFor="autorizacion-datos">
          ...
          <ModalTerms  isOpen={isModalOpen} onAccept={() => handleAcceptTerms(setFieldValue)} onClose={handleCloseModal} />
        </Form>
      )}
    </Formik>
  );
